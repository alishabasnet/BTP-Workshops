...
int main()
{
	...
	seneca::Pair<seneca::Book, int> *ret2 = seneca::matches(bks, x, sizeof(bks) / sizeof(bks[0]), size1, size3);
	...
	seneca::Pair<seneca::Book, double> *ret3 = seneca::matches(bks, y, sizeof(bks) / sizeof(bks[0]), size2, size3);
	...
	seneca::Pair<seneca::Student, int> *ret4 = seneca::matches(stds, x, sizeof(stds) / sizeof(stds[0]), size1, size3);
	...
	seneca::Pair<seneca::Student, double> *ret5 = seneca::matches(stds, y, sizeof(stds) / sizeof(stds[0]), size2, size3);
	...
	seneca::Pair<seneca::Student, seneca::Book> *ret6 = seneca::matches(stds, bks, sizeof(stds) / sizeof(stds[0]), sizeof(bks) / sizeof(bks[0]), size3);
